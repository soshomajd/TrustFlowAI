...
namespace TrustFlow.Api.Migrations
{
    ...
    [Migration("20260809103428_AddWalletIdentity")]
    partial class AddWalletIdentity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TrustFlow.Api.Models.Escrow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("CancellationTransactionHash")
                        .HasMaxLength(66)
                    ...
                    b.Property<string>("ClientWalletAddress")
                        .HasMaxLength(42)
                    ...
                    b.Property<string>("DeploymentTransactionHash")
                        .HasMaxLength(66)
                        .HasColumnType("character varying(66)");

                    b.Property<string>("FreelancerWalletAddress")
                        .HasMaxLength(42)
                        .HasColumnType("character varying(42)");
                    ...
                    b.Property<string>("Status")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text")
                        .HasDefaultValue("PendingDeployment");
                    ...
                    b.HasIndex("ContractAddress")
                        .IsUnique()
                        .HasDatabaseName("IX_Escrows_ContractAddress")
                        .HasFilter("\"ContractAddress\" IS NOT NULL");

                    b.HasIndex("ProjectId")
                        .IsUnique();

                    b.HasIndex("Status", "UpdatedAt")
                        .HasDatabaseName("IX_Escrows_Status_UpdatedAt");

                    b.ToTable("Escrows", t =>
                        {
                            t.HasCheckConstraint("CK_Escrows_ChainId_Positive", "\"ChainId\" > 0");

                            t.HasCheckConstraint("CK_Escrows_ReleasedAmount_NonNegative", "\"ReleasedAmount\" >= 0");

                            t.HasCheckConstraint("CK_Escrows_ReleasedAmount_WithinTotal", "\"ReleasedAmount\" <= \"TotalAmount\"");

                            t.HasCheckConstraint("CK_Escrows_TotalAmount_Positive", "\"TotalAmount\" > 0");
                        });
                });
            ...
            modelBuilder.Entity("TrustFlow.Api.Models.Identity.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("PendingWalletAddress")
                        .HasMaxLength(42)
                        .HasColumnType("character varying(42)");
                    ...
                    b.Property<string>("WalletAddressNormalized")
                        .HasMaxLength(42)
                        .HasColumnType("character varying(42)");

                    b.Property<DateTimeOffset?>("WalletVerificationExpiresAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("WalletVerificationNonce")
                        .HasMaxLength(64)
                    ...
                    b.HasIndex("WalletAddressNormalized")
                        .IsUnique()
                        .HasDatabaseName("IX_AspNetUsers_WalletAddressNormalized")
                        .HasFilter("\"WalletAddressNormalized\" IS NOT NULL");
            ...
            modelBuilder.Entity("TrustFlow.Api.Models.Escrow", b =>
                {
                    b.HasOne("TrustFlow.Api.Models.Project", "Project")
                        .WithOne("Escrow")
                        .HasForeignKey("TrustFlow.Api.Models.Escrow", "ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
