...
import { createMilestoneSchema, type CreateMilestoneFormInput, type CreateMilestoneFormOutput, } from
...
export function CreateMilestoneForm({
    ...
    function handleSubmit(
        values: CreateMilestoneFormOutput,
    ) {
        ...
        >
            ...
            <div className="space-y-2">
                ...
                <Textarea
                    ...
                    placeholder="Describe what must be delivered for this milestone."
                    rows={5}
                    disabled={isSubmitting}
                    aria-invalid={
                        Boolean(
